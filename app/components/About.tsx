...
const About = () => {
    return (
        ...
        <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
            <div className="bg-darkHover shadow-black p-10">
  Test
</div>
                ...
                <div className='flex-1'>
                    ...
                    <ul className='grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-2xl'>
                        {infoList.map(({icon, iconDark, title, description}, index)=>(
                            <li className='border-[0.5px] border-gray-500 rounded-xl p-6 cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-200 hover:shadow-black' key={index}>
